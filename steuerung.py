...
class Steuerung():
    ...
    def __init__(self):
        ...
        self.Event_1 = Event()
        self.Spieler_1 = Spieler((0.5*self.Spielfeld_1.Spielfeld_width), (self.Spielfeld_1.Spielfeld_height*0.5))
        self.Spieler_2 = Spieler((1.5*self.Spielfeld_1.Spielfeld_width), (self.Spielfeld_1.Spielfeld_height*0.5))
